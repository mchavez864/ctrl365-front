    ...
    >
      <div className="text-center relative z-10 py-16 lg:flex lg:items-center lg:justify-between lg:pt-64 lg:pb-32">
        <h1 className="text-grey-10 mb-8 lg:mb-0">
          <WordReveal applyGradient centered>{t('title')}</WordReveal>
        </h1>
        <p className="text-white !text-[18px] lg:max-w-[500px] text-left">
          <WordReveal delay={0.3} wordGap={2}>{t('description')}</WordReveal>
        </p>
      </div>
      <div className="relative z-20 pt-16 pb-32 lg:pt-32 lg:max-w-[824px]">
        ...
        />
        <h2 className="text-white mb-8"><WordReveal delay={0.6} wordGap={5}>{t('subtitle')}</WordReveal></h2>
        <p className="text-white !text-[18px]"><WordReveal delay={0} wordGap={2.5}>{t('content')}</WordReveal></p>
      </div>
      <div className="relative z-20 flex flex-col gap-4 lg:flex-row">
        <FadeInUp delay={0} yOffset={100} className="lg:w-[50%]">
          <BigCard
        ...
        <FadeInUp delay={0.3} yOffset={100} className="lg:w-[50%]">
          <BigCard
