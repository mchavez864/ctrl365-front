    ...
    <AnimatePresence>
      {showBanner && (
        <motion.div
          ...
          className="fixed bottom-4 left-4 right-4 md:right-auto md:left-16 md:bottom-8 md:max-w-[580px] z-50  lg:bottom-16  xxl:left-32"
        >
          <div className="bg-grey-40 text-center rounded-2xl p-4 shadow-2xl border border-grey-30/20 relative overflow-hidden md:p-8 md:text-left">
            ...
            <div className="flex flex-col gap-3 md:flex-row relative z-10">
              <Button
                ...
                variant="white"
                className="!w-full md:!w-[320px] md:order-2 !bg-white !h-[50px]"
              />
              <Button
                copy={t('decline')}
