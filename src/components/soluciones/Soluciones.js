...
const Soluciones = () => {
  ...
  const sliderData = [
    { img: "./images/pages/home/solutions/card-1-desktop.png", title: t("title1"), text: t("text1") },
    { img: "./images/pages/home/solutions/card-2-desktop.png", title: t("title2"), text: t("text2") },
    { img: "./images/pages/home/solutions/card-3-desktop.png", title: t("title3"), text: t("text3") },
    { img: "./images/pages/home/solutions/card-4-desktop.png", title: t("title4"), text: t("text4") },
  ];
        ...
        <div className="absolute bottom-0 left-0 w-full lg:h-[35%] xxl:h-[30%] flex flex-row lg:px-[64px] lg:pb-[64px] xxl:px-[128px]">
          ...
          <div className="h-full w-[55%] flex flex-col lg:pl-[64px] lg:pr-[150px]">
            ...
            <div className="w-full h-[60%] flex flex-col gap-[8px] items-start justify-center">
              <h2 className={`text-white transition-opacity duration-500 ease-out ${showContent ? "opacity-100" : "opacity-0"}`}>{sliderData[actualSlide - 1].title}</h2>
