        ...
        <div className="absolute bottom-0 left-0 w-full lg:h-[35%] xxl:h-[30%] flex flex-row lg:px-[64px] lg:pb-[64px] xxl:px-[128px]">
          <div className="h-full w-[15%] flex flex-row items-start justify-center">
            <div
              ...
              className={`cursor-pointer w-auto h-auto px-[32px] py-[16px] rounded-[900px] translate-x-[10px] ${
                buttonPrevActive
                  ? 'glass'
                  : 'bg-grey-10 border-[1px] border-grey-20'
              }`}
            >
              <svg
          ...
          <div className="h-full w-[55%] flex flex-col lg:pl-[64px] lg:pr-[150px]">
            <div
              className={`w-full h-[20%] flex flex-row items-start justify-start gap-[8px] transition-opacity duration-500 ease-out ${
            ...
            >
              ...
              <p className="text-[16px] font-[500] leading-[120%] text-white">
                {t('sectionTitle')}
              </p>
            </div>
            <div className="w-full h-[60%] flex flex-col gap-[8px] items-start justify-center">
              ...
              <p
                className={`text-white text-[16px] font-[400] leading-[120%] transition-opacity duration-500 ease-out ${
                  showContent ? 'opacity-100' : 'opacity-0'
                }`}
              >
                {sliderData[actualSlide - 1].text}
              </p>
            </div>
            <div
              className={`w-full h-[20%] flex flex-col gap-[8px] justify-end items-start`}
            >
          ...
          <div className="h-full w-[30%] flex flex-col items-start justify-between">
              ...
              {titleSection.map((title, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-[16px] font-[500] leading-[120%]">
                      {title.toUpperCase()}
                    </p>
                  </div>
                );
            ...
            <div className="w-full h-auto flex flex-row items-center justify-start gap-[10px]">
              <p className="text-[16px] font-[400] leading-[120%] text-[#9e9e9e]">
                Secure
              </p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="w-full h-[100dvh] relative bg-grey-10 hidden md:block overflow-hidden lg:hidden pt-[64px]">
        ...
        >
          {sliderData.map((slides, index) => {
            ...
            return (
              <div
                key={index}
                className={`w-[40vw] h-full rounded-[16px] relative`}
                style={backgroundStyleTablet}
              >
                <div className="absolute bottom-0 left-0 w-full h-auto flex flex-col gap-[8px] items-center px-[16px] pb-[32px]">
                  ...
                  <div className="w-full h-[60%] flex flex-col items-center justify-center">
                    <h2 className="text-white text-center text-[24px] font-[400] leading-[110%] tracking-[-0.24px]">
                      {slides.title}
                    </h2>
                    <p className="text-white text-[16px] font-[400] leading-[120%] text-center mt-[2px]">
                      {slides.text}
                    </p>
                  </div>
                  <div className="w-full h-auto flex flex-row items-center justify-center gap-[6px] mt-[24px]">
                    <p className="!text-[12px] md2:text-[14px] font-[400] leading-[120%] text-[#9e9e9e]">
                      Secure
                    </p>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="mt-[32px] button-0 left-0 w-full h-auto flex flex-row items-end px-[64px]">
          <div className="h-full w-full flex flex-row items-center justify-end">
            <div
              onClick={(e) => handlePrevButtonSlide(e)}
              className={`cursor-pointer w-auto h-auto px-[32px] py-[16px] rounded-[900px] translate-x-[20px] ${
                buttonPrevActiveTablet
                  ? 'glass'
                  : 'bg-grey-10 border-[1px] border-grey-20'
              }`}
            >
            ...
            <div
              onClick={(e) => handleNextButtonSlide(e)}
              className={`cursor-pointer w-auto h-auto px-[32px] py-[16px] rounded-[900px] ${
                buttonNextActiveTablet
                  ? 'glass'
                  : 'bg-grey-10 border-[1px] border-grey-20'
              }`}
            >
      ...
      <section className="w-full h-[100dvh] relative bg-grey-10 md:hidden py-[64px]">
        <div className="w-auto h-[80%] mx-[16px] bg-grey-40 rounded-[16px] relative">
          ...
          <div className="absolute bottom-0 left-0 w-full h-auto gap-[8px] flex flex-col items-center pb-[32px] px-[16px]">
            <div
              className={`text-center w-full h-[20%] flex flex-row items-center justify-center gap-[8px] transition-opacity duration-500 ease-out ${
                showContent ? 'opacity-100' : 'opacity-0'
              }`}
            >
              <svg
            ...
            <div
              className={`text-center w-full h-[60%] flex flex-col items-center justify-center transition-opacity duration-500 ease-out ${
                showContent ? 'opacity-100' : 'opacity-0'
              }`}
            >
            ...
            <div
              className={`w-full h-auto flex flex-row items-center justify-center gap-[10px] transition-opacity duration-500 ease-out mt-[24px] ${
                showContent ? 'opacity-100' : 'opacity-0'
              }`}
            >
              <p className="text-[16px] font-[400] leading-[120%] text-[#9e9e9e]">
