    ...
    <section className="relative h-[655px] md:h-[438px] lg:h-[603px] xxl:h-[651px] bg-grey-40 px-[16px] md:px-[64px] py-[64px] lg:py-[128px] xxl:px-[408px] overflow-hidden ">
      ...
      <div className="relative z-30 flex flex-col items-start justify-between h-full">
        ...
        <p className="h3 text-grey-20">
          <Character value="Creemos en una tecnología que genera resultados reales, no promesas. " />
          <span className="text-grey-20 inline">
            Diseñamos inteligencia que impulsa a las organizaciones a moverse
            más rápido, decidir mejor y alcanzar más —con propósito real y
            humano."
          </span>
        </p>
        <div className="flex items-center gap-[16px] self-end">
          ...
          <div className="flex flex-col text-grey-00 max-w-[200px] z-30 md:max-w-full">
            <p className="font-bold!">Erik Dziubak</p>
            <p>Chief Visionary Officer at Ctrl365</p>
          </div>
        </div>
      </div>
    </section>
