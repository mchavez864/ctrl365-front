    ...
    <footer className="relative bg-grey-40 h-full w-full overflow-hidden">
      <div className="relative z-10 pt-[128px] pb-[64px]">
        ...
        <div className="h-[300px] w-full relative mt-[32px]">
            <div 
              className="absolute right-[-1px] overflow-hidden rounded-l-[999px] w-[70%] h-full gradient-border-rounded"
            ></div>
            <div 
              className="absolute left-[-1px] overflow-hidden rounded-r-[999px] w-[70%] h-full gradient-border-dark"
            ></div>
        </div>
        <div className="px-[16px] mt-[32px]">
            <Logo color="white" />
            <div className="flex items-center justify-between h-[132px] mt-[16px]">
            ...
            <p className="text-grey-20 text-center leading-[120%]">© Ctrl365 - All rights reserved.</p>
        </div>
      </div>
