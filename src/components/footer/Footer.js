    ...
    <footer className="relative bg-grey-40 h-full w-full overflow-hidden">
      <div className="relative z-10 pt-[128px] md:pt-[64px] pb-[64px] lg:mt-[160px]">
        <div className="lg:relative ">
          <div className="px-[16px] md:px-[64px] lg:absolute z-10 lg:top-[50%] lg:-translate-y-1/2">
          ...
          <div className="px-[16px] md:px-[64px] mt-[32px] md:mt-[64px] lg:absolute lg:bottom-[75px] lg:left-0 lg:flex lg:justify-between lg:items-center lg:w-full ">
            <Logo
              color="white"
        ...
        <div className="px-[16px] md:px-[64px] lg:mt-[64px]">
